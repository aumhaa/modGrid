...
def checkpad(button):
	return hasattr(button, 'name') and button.name == 'Pad_0'
...
class MPEPlayableControl(PlayableControl):
	...
	class State(PlayableControl.State):
		...
		def set_control_element(self, control_element):
			# debug('set_control_element:', control_element)
			# if checkpad(control_element):
			# 	debug('set_control_element:', control_element.name)
