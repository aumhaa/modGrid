...
class LoopSelectorComponent(Component, Messenger):
	...
	"""
	play_selected_clip_button = DisplayingButtonControl(text="PlaySlctd", color="LoopSelector.Bank")
	favorite_clip_color_button = DisplayingButtonControl(text="FavColor", color="LoopSelector.Bank")
	fix_grid_button = DisplayingButtonControl(text="FixGrid", color="LoopSelector.Bank")
	loop_length_1_button = DisplayingButtonControl(text="Length1", color="LoopSelector.Bank")
	loop_length_2_button = DisplayingButtonControl(text="Length2", color="LoopSelector.Bank")
	loop_length_4_button = DisplayingButtonControl(text="Length4", color="LoopSelector.Bank")
	loop_length_8_button = DisplayingButtonControl(text="Length8", color="LoopSelector.Bank")
	loop_length_16_button = DisplayingButtonControl(text="Length16", color="LoopSelector.Bank")
	next_page_button = DisplayingButtonControl(text="Page->", color="LoopSelector.Bank")
	prev_page_button = DisplayingButtonControl(text="<-Page", color="LoopSelector.Bank")
	shift_loop_right_keycommand_button = DisplayingButtonControl(text="Shift->", color="LoopSelector.ShiftLoop")
	shift_loop_left_keycommand_button = DisplayingButtonControl(text="<-Shift", color="LoopSelector.ShiftLoop")
	shift_loop_right_button = DisplayingButtonControl(text="Shift->", color="LoopSelector.ShiftLoop")
	shift_loop_left_button = DisplayingButtonControl(text="<-Shift", color="LoopSelector.ShiftLoop")
	latest_loop_button = DisplayingButtonControl(text="LstLoop", color="LoopSelector.LatestLoop")
	latest_loop_keycommand_button = DisplayingButtonControl(text="LstLoop", color="LoopSelector.LatestLoop")
	toggle_recording_on_all_clips_and_loop_button = DisplayingButtonControl(text="TglRec+Loop", color="LoopSelector.LatestLoop")
	delete_button = DisplayingButtonControl(text="Delete")
	select_button = DisplayingButtonControl(text="Select")
